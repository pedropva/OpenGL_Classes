...
void onGlfwInit();
void onGlewInit();
void createWindow(char* title, GLuint width, GLuint height);
vector<vec3> verticesColors(int nVertices);
...
int main(){
	...
	vector<vec2> uvs;
	vector<vec3> normals;
	bool isObjLoaded = loadOBJ("Models/teapot.obj", vertices, uvs, normals);
